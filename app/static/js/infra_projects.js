...
const columnDefs = [
  ...
  { field: "contract_name", headerName: "사업명", flex: 1, minWidth: 200 },
  {
    ...
    cellDataType: false,
    valueGetter: (params) => params.data?.is_completed ? "완료" : "진행중",
    cellClass: (params) => params.data?.is_completed ? "grid-status-completed" : "grid-status-active",
  },
...
const deliverableColDefs = [
  ...
  { field: "name", headerName: "산출물명", flex: 1, minWidth: 200, editable: true },
  {
    ...
    valueGetter: (params) => params.data?.is_submitted ? "제출" : "미제출",
    cellClass: (params) => params.data?.is_submitted ? "grid-status-active" : "grid-status-planned",
  },
