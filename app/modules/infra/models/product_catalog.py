...
class ProductCatalog(TimestampMixin, Base):
    ...
    research_provider: Mapped[str | None] = mapped_column(String(30), nullable=True)
    ...
    model_family: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    is_family_level: Mapped[bool] = mapped_column(Boolean, default=False, server_default="false")
