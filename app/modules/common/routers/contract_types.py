"""ContractTypeConfig CRUD 공통 라우터."""
...
from app.modules.common.schemas.contract_type_config import (
    ContractTypeCreate,
    ContractTypeRead,
    ContractTypeUpdate,
)
from app.modules.common.services import contract_type_config as svc
...
def create_contract_type(
    ...
    return svc.create_contract_type(
        db,
        data.code,
        data.label,
        data.sort_order,
        defaults=data.model_dump(exclude={"code", "label", "sort_order"}),
    )
