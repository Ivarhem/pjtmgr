...
from app.modules.accounting.schemas.report import TargetVsActualResponse
from app.modules.accounting.services import dashboard as svc
...
def get_dashboard_summary(
    ...
    partner_id: Annotated[list[int] | None, Query()] = None,
