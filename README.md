...
| **인프라 (infra)** | 프로젝트, 자산, IP 인벤토리, 포트맵, 정책 현황 | 이식 예정 |
...
| **프로젝트 관리** | 프로젝트 기본정보, 단계, 산출물 제출 현황 | infra (이식 예정) |
| **기술 자산** | Asset CRUD, 유형/역할/환경/상태 관리 | infra (이식 예정) |
| **네트워크** | IP 인벤토리, 포트맵 CRUD | infra (이식 예정) |
| **정책** | 정책 정의, 프로젝트/자산별 적용 상태 | infra (이식 예정) |
...
- 모듈화 마이그레이션 진행 중 (문서가 목표 구조를 선행 반영)
